...
-- 6. Recreate folder-recipes junction
...
-- 8. Recreate meal_dates and meal_date_recipes
...
-- 10. RLS policies using Clerk JWT sub claim (auth.jwt()->>'sub')
